...
; run at 10:00am, which is 1000. Sets the value of TargetTime to 1000, which corresponds to 10:00 am in the 24-hour time format
TargetTime = 1000
...
; Appends the TargetTime (1000) to the end of the TargetDateTime variable. So, the value of TargetDateTime becomes something like 20220303400 || 2022/03/03/1000
...
; PressTheKey subroutine that is executed when the timer set in the previous line expires. This subroutine turns off the timer, and then sends the key "Esc" to the active window. The return statement marks the end of the subroutine
PressTheKey:
    SetTimer, PressTheKey, off
    Send, {Esc} ; i.e. press only once
return